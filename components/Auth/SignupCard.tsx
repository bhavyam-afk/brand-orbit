...
const SignupCard = ({ userType }: SignupCardProps) => {
  ...
  return (
    <div className="bg-[#222] rounded-2xl shadow-2xl p-10 w-[400px] max-w-full text-white flex flex-col gap-6">
      ...
      <h2 className="text-3xl font-bold mb-2 text-center">Sign Up {userType === "brand" ? "as Brand" : "as Creator"}
      </h2>
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <LiquidButton type="submit" className="mt-4 w-full invert">Sign Up</LiquidButton>
